...
if __name__ == "__main__":
    # os.environ['CUDA_VISIBLE_DEVICES'] = "0"  # 设置默认的显卡
    # args = default_argument_parser().parse_args()
    # # args.config_file = './configs/icoco/defrcn_r101_base.yaml'  # 添加参数文件
    # args.config_file = './configs/ifsod/defrcn_ifsod_r101_novel_10shot.yaml'  # 添加参数文件
    # args.eval_only = True
    # args.opts = ['MODEL.WEIGHTS', './output/icoco/finetune_gfmv42+drpn+pdc_novel_10shot/model_0003499.pth', 
    #              'OUTPUT_DIR', './output/icoco/inference/']
