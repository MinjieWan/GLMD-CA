...
if __name__ == '__main__':
    ...
    parser.add_argument('--src-path', type=str, default="/home/nvidia/xuyunkai/DetectionMethods/Ours_DeFRCN/output/icoco/train_gfmv48/model_final.pth", help='Path to the main checkpoint')
    parser.add_argument('--save-dir', type=str, default="/home/nvidia/xuyunkai/DetectionMethods/Ours_DeFRCN/output/icoco/train_gfmv48/", help='Save directory')
    parser.add_argument('--method', choices=['remove', 'randinit'], default='remove',
